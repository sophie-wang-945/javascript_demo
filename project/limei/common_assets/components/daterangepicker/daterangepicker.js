...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container.find('.range_inputs').on('click', 'button.applyBtn', $.proxy(this.clickApply, this));
        this.container.find('.range_inputs').on('click', 'button.cancelBtn', $.proxy(this.clickCancel, this));
